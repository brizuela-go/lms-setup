    ...
    <div className="container py-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <SubjectCreationDialog teachers={teachers} />
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex justify-between items-center">
            ...
            <CardDescription>Total: {subjects.length} materias</CardDescription>
          </div>
        </CardHeader>
        ...
        <CardFooter className="flex items-center justify-between py-4">
          <div className="text-sm text-muted-foreground">
            Mostrando <span className="font-medium">{subjects.length}</span> de{" "}
            <span className="font-medium">{subjects.length}</span> materias
          </div>
          <div className="flex items-center gap-2">
